...
# map queries to blon names for easier reading
...
df = pd.DataFrame(np.nan, index = range(0,len(queries_map)), columns = ["query", "genome", "length"])
...
df_pivot.to_csv("output/df_pivot.tsv", sep = '\t')
